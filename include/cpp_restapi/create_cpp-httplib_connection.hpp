...
#ifndef CREATE_CPP_HTTPLIB_CONNECTION_HPP_INCLUDED
#define CREATE_CPP_HTTPLIB_CONNECTION_HPP_INCLUDED
...
namespace cpp_restapi
{
     ...
     */
    CPP_RESTAPI_EXPORT std::unique_ptr<IConnection> createCppHttplibConnection(
